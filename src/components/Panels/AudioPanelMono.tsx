...
const AudioSourcePanel: React.FC<AudioPanelProps> = ({ audioTracks, setAudioSource, setAudioContext }) => {
    ...
    return <div style={{ display: 'flex', gap: PADDING.small }}>
        ...
        <AudioPlayer trackUrl={audioTrack?.src} setAudioSource={setAudioSource} setAudioContext={setAudioContext} />
    </div>
}
