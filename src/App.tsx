        ...
        >
            ...
            {PAGES.map((p) => (
              <button
                style={{
                  ...
                  backgroundColor:
                    p === pageInfo ? COLORS.primary : COLORS.interact_color,
          ...
          <div>
            <a href="https://github.com/sdfgeoff/MixingDeskTrainer">
              View on <img style={{ height: "1em" }} alt="" src={GITHUB_LOGO} />
            </a>
          </div>
        </div>
        <hr
          style={{
            padding: 0,
            margin: 0,
            borderColor: COLORS.interact_color,
            borderWidth: "2px",
          }}
        />
      </div>
      <div>{pageInfo && React.createElement(pageInfo.component)}</div>
    </div>
  );
}
