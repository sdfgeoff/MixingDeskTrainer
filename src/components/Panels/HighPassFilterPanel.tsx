...
export const HighPassFilterPanel: React.FC<HighPassFilterProps> = ({ highPassFilter, onChangeHighPassFilter }) => {
    return <div style={{ display: 'flex', flexDirection: 'column', gap: PADDING.small }}>
        <LabelledControl label="Frequency">
            <KnobControl
                ...
                min={50}
                max={20000}
                onChange={(val) => onChangeHighPassFilter((prev) => {
                    return {
                        ...prev,
                        frequency: val
                    }
        ...
        <LabelledControl label="In">
            <LEDButtonRound
                ...
                onClick={() => onChangeHighPassFilter((prev) => ({
                    ...prev,
